...
RSpec.describe 'タスク管理機能', type: :system do
  before do
    ...
    @test_label1 = create(:label, user_id: @user.id)
    @test_label2 = create(:label, user_id: @user.id)
    @test_label3 = create(:label, user_id: @user.id)
  ...
  describe 'タスク一覧画面' do
    ...
    context 'タスクを作成した場合' do
      ...
      it '複数のタスクをつけられること' do
        ...
        expect(page).to have_content @test_label1, @test_label2
      end
